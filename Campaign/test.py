...
class MyGameView(arcade.View):
    ...
    def on_draw(self):
        ...
        arcade.draw_rectangle_filled(900, 25, 250, 60, arcade.csscolor.SILVER)
        # Put the text on the screen.
        output = f"Purple Votes: {self.pscore}"
        arcade.draw_text(output, 785, 10, arcade.color.PURPLE, 25)

        arcade.draw_rectangle_filled(900, -35, 250, 60, arcade.csscolor.SILVER)
        # Put the text on the screen.
        output = f"Green Votes: {self.gscore}"
        arcade.draw_text(output, 785, -50, arcade.color.GREEN, 25)

        arcade.draw_rectangle_filled(1150, -35, 250, 60, arcade.csscolor.SILVER)
        # Put the text on the screen.
        output = f"Total Votes: {self.pscore + self.gscore}"
        arcade.draw_text(output, 1030, -50, arcade.color.MIDNIGHT_BLUE, 25)
